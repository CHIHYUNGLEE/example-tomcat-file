...
rem set JAVA_HOME=C:\Program Files\Java\jdk1.8.0_341 
rem set JAVA_HOME=C:\Program Files\Java\jdk1.8.0_341
rem set CATALINA_HOME=C:\tomcat\apache-tomcat-7.0.109_police
set CATALINA_HOME=D:\tomcat\apache-tomcat-8.5.81_kdissw
set CATALINA_OPTS=-Xmx1024m -Dkcube.configuration=kcube_KDISSW_local.xml -Dkcube.appbase=%KCUBE_APPBASE% -Djava.net.preferIPv4Stack=true -XX:PermSize=256m -XX:MaxPermSize=256m -Dfile.encoding=UTF-8
