...
set CATALINA_HOME=D:\tomcat\apache-tomcat-8.5.81_cskcube
set CATALINA_OPTS=-Xmx1024m -Dkcube.configuration=kcube_KCUBE_LOCAL.xml -Dkcube.appbase=%KCUBE_APPBASE% -Djava.net.preferIPv4Stack=true -XX:PermSize=256m -XX:MaxPermSize=256m -Dfile.encoding="UTF-8"
