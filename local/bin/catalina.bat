...
set CATALINA_HOME=D:\tomcat\apache-tomcat-8.5.81_localR6
set CATALINA_OPTS=-Xmx1024m -Dkcube.configuration=kcube_LOCAL_local.xml -Dkcube.appbase=%KCUBE_APPBASE% -Djava.net.preferIPv4Stack=true -XX:PermSize=256m -XX:MaxPermSize=256m -Dfile.encoding=UTF-8
